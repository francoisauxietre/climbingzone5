...
import { ClimbingRouteComponent } from 'app/entities/climbing-route/climbing-route.component';
...
describe('Component Tests', () => {
  describe('ClimbingRoute Management Component', () => {
    let comp: ClimbingRouteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClimbingRouteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.climbingRoutes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
