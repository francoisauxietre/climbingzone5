...
import { ClimberComponent } from 'app/entities/climber/climber.component';
import { ClimberService } from 'app/entities/climber/climber.service';
import { Climber } from 'app/shared/model/climber.model';

describe('Component Tests', () => {
  describe('Climber Management Component', () => {
    let comp: ClimberComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ClimberComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.climbers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
