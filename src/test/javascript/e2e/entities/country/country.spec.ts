...
describe('Country e2e test', () => {
  ...
  it('should load Countries', async () => {
    ...
    expect(await countryComponentsPage.getTitle()).to.eq('climbingzone5App.country.home.title');
  });
  ...
  it('should load create Country page', async () => {
    ...
    expect(await countryUpdatePage.getPageTitle()).to.eq('climbingzone5App.country.home.createOrEditLabel');
  ...
  it('should create and save Countries', async () => {
    ...
    await countryComponentsPage.clickOnCreateButton();
    await promise.all([countryUpdatePage.setNameInput('name'), countryUpdatePage.climbersSelectLastOption()]);
  ...
  it('should delete last Country', async () => {
    ...
    expect(await countryDeleteDialog.getDialogTitle()).to.eq('climbingzone5App.country.delete.question');
